...
``` shell
go install github.com/anhro/wire/cmd/wire@latest
```
...
$GOPATH/src/github.com/anhro/wire/_tutorial/wire.go:24:1:
inject InitializeEvent: no provider found for github.com/anhro/wire/_tutorial.Greeter
(required by provider of github.com/anhro/wire/_tutorial.Event)
